...
@section('title','Danh sách đơn hàng đã giao')
...
<div class="topnav">
    ...
    <a class="active" href="{{ route('orders_delivered') }}">Đơn hàng đã giao</a>
                       ...
                       <table id="bootstrap-data-table" class="table table-striped table-bordered">
                           ...
                           <tbody>
                            ...
                            <tr>
                                ...
                                <td id="chuc_nang">
                                  <a href="{{ route('orders_lines',['Id' => $oders[$i]->Id]) }}"><i style="color:midnightblue" class="fas fa-eye"></i> Xem chi tiết</a>
                                </td>
                            </tr>
