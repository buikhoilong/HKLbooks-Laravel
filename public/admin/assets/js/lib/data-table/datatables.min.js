                    ...
                    if (((e = e || []), 1 === o.length)) {
                        ...
                        while (i--) {
                            ...
                            if (
                                ...
                                (f = m(
                                    k.matches[0].replace(ca, da),
                                    (aa.test(j[0].type) && pa(b.parentNode)) ||
                                        b
                                ))
                            ) {
                                if (
    ...
    var S = function (g) {
                ...
                if (0 !== j.length) {
                    ...
                    for (i = i ? 0 : h; i < f; i++) {
                        ...
                        if (0 !== e) {
                            var q = d[c % e];
                            r._sRowStripe != q &&
                                (g(l).removeClass(r._sRowStripe).addClass(q),
                                (r._sRowStripe = q));
                        }
                        ...
                        if (g.isArray(a) || a instanceof g)
                            ...
                            a.nodeName && "tr" === a.nodeName.toLowerCase()
                                ...
                                : ((c = g("<tr><td/></tr>").addClass(b)),
                                  (g("td", c).addClass(b).html(a)[0].colSpan =
                                      ba(d)),
                                  e.push(c[0]));
                    };
                f(a, b);
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "Hiện _START_-_END_ / _TOTAL_ dòng",
                sInfoEmpty: "Hiện 0-0 / 0 dòng",
                sInfoFiltered: "(lọc ra từ _MAX_ dòng)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: " Số dòng hiển thị:_MENU_",
