...
Route::prefix('/admin')->middleware('adminrole')->group(function () {
    ...
    Route::prefix('/promotes')->group(function () {
        ...
        Route::post('/post_promote/{Id?}',[PromotesController::class,'postPromote'])->name('post_promote');
        ...
        // thêm thể loại promote
        Route::get('get_add_promote_type',[PromotesController::class,'getAddPromoteType'])->name('get_add_promote_type');
